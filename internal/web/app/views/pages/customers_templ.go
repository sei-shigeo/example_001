...
func Customers(customers []*db.Customer) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = CustomerCreate().Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "</div><h1>取引先一覧</h1><div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if len(customers) == 0 {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "<p>取引先が存在しません</p>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
		...
		for _, customer := range customers {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/app/views/pages/customers.templ`, Line: 39, Col: 25}
			}
			...
			templ_7745c5c3_Var3, templ_7745c5c3_Err = templ.JoinStringErrs(customer.Email)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/app/views/pages/customers.templ`, Line: 45, Col: 26}
			}
			...
			templ_7745c5c3_Var4, templ_7745c5c3_Err = templ.JoinStringErrs(customer.Phone)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/app/views/pages/customers.templ`, Line: 51, Col: 26}
			}
		...
		templ_7745c5c3_Err = CustomerEdit(customers[0]).Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
...
// 作成フォーム
func CustomerCreate() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		templ_7745c5c3_W, ctx := templ_7745c5c3_Input.Writer, templ_7745c5c3_Input.Context
		if templ_7745c5c3_CtxErr := ctx.Err(); templ_7745c5c3_CtxErr != nil {
			return templ_7745c5c3_CtxErr
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, "<div id=\"customerCreateForm\" class=\"flex flex-col gap-4\"><label class=\"block text-sm font-medium text-gray-700\"><span>名前</span> <input type=\"text\" data-bind=\"createName\" placeholder=\"名前\" class=\"border border-gray-300 rounded-md p-2 w-full\"></label> <label class=\"block text-sm font-medium text-gray-700\"><span>メール</span> <input type=\"text\" data-bind=\"createEmail\" placeholder=\"メール\" class=\"border border-gray-300 rounded-md p-2 w-full\"></label> <label class=\"block text-sm font-medium text-gray-700\"><span>電話番号</span> <input type=\"text\" data-bind=\"createPhone\" placeholder=\"電話番号\" class=\"border border-gray-300 rounded-md p-2 w-full\"></label><div class=\"flex items-center gap-2 mt-2\"><button type=\"submit\" class=\"bg-blue-400 hover:bg-blue-500 transition-all duration-300 text-white px-4 py-2 rounded-md w-full cursor-pointer\">保存</button> <button type=\"reset\" class=\"bg-gray-400 hover:bg-gray-500 transition-all duration-300 text-white px-4 py-2 rounded-md w-full cursor-pointer\">キャンセル</button></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
// 編集フォーム
func CustomerEdit(customer *db.Customer) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		templ_7745c5c3_W, ctx := templ_7745c5c3_Input.Writer, templ_7745c5c3_Input.Context
		if templ_7745c5c3_CtxErr := ctx.Err(); templ_7745c5c3_CtxErr != nil {
			return templ_7745c5c3_CtxErr
		...
		templ_7745c5c3_Var7, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("customerEditForm-%d", customer.ID))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/app/views/pages/customers.templ`, Line: 91, Col: 58}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/app/views/pages/customers.templ`, Line: 110, Col: 65}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/app/views/pages/customers.templ`, Line: 110, Col: 95}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/app/views/pages/customers.templ`, Line: 114, Col: 68}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/app/views/pages/customers.templ`, Line: 114, Col: 99}
		}
		...
		templ_7745c5c3_Var12, templ_7745c5c3_Err = templ.JoinStringErrs(customer.Phone)
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/app/views/pages/customers.templ`, Line: 118, Col: 66}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/app/views/pages/customers.templ`, Line: 118, Col: 97}
		}
